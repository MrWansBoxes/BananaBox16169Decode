...
public class Auto1 extends OpMode {
    ...
    private final Pose pickup1Pose = new Pose(102.1607898448519, 83.475317348378, Math.toRadians(360)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose pickup2Pose = new Pose(121.65867418899859, 83.475317348378, Math.toRadians(360)); // Middle (Second Set) of Artifacts from the Spike Mark.
    ...
    private final Pose lineupPose = new Pose(111.50352609308887, 83.475317348378, Math.toRadians(360)); // Lowest (Third Set) of Artifacts from the Spike Mark.
