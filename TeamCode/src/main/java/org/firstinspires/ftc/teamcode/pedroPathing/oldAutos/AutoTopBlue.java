package org.firstinspires.ftc.teamcode.pedroPathing.oldAutos; // make sure this aligns with class location
...
public class AutoTopBlue extends OpMode {
    ...
    private final Pose startPose = new Pose(30, 135.4696, Math.toRadians(90)); // Start Pose of our robot.
    private final Pose path1 = new Pose(54.8378, 88.5528, Math.toRadians(135)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose path2 = new Pose(15.25233644859813, 106.09345794392524, Math.toRadians(90)); // private final Pose path2 = new Pose(41.0268, 83.6784, Math.toRadians(180)); //
    private final Pose path3 = new Pose(12, 83.4753, Math.toRadians(180)); // Middle (Second Set) of Artifacts from the Spike Mark.
    private final Pose path4 = new Pose(54.8378, 88.5528, Math.toRadians(135)); // Lowest (Third Set) of Artifacts from the Spike Mark.
    private final Pose path5 = new Pose(15.4359, 75.7574, Math.toRadians(90));// open gate
    private final Pose path20 = new Pose(89.3653, 70.2736, Math.toRadians(180));
    private final Pose path6 = new Pose(40.4175, 59.9153, Math.toRadians(180));
    private final Pose path7 = new Pose(4, 59.5091, Math.toRadians(180));
    private final Pose path8 = new Pose(54.8378, 88.5528, Math.toRadians(135));
    private final Pose path9 = new Pose(40.4175, 35.3399, Math.toRadians(180));
    private final Pose path10 = new Pose(4, 35.5430, Math.toRadians(180));
    private final Pose path11 = new Pose(54.8378, 88.5528, Math.toRadians(135));
    private final Pose path14 = new Pose(54.8378, 88.5528, Math.toRadians(135));
    private final Pose path15 = new Pose(41.8393, 57.4781, Math.toRadians(180));
